...
$columns= ['schedule_id','name','contact_number', 'service_name','date','time','total_order','payment','date_ordered'];
...
$query = "SELECT ".$columnName." FROM $tableName"." ORDER BY schedule_id DESC";
...
if(isset($_POST['submit'])){
    ...
    $insert_query = mysqli_query($conn, "insert into products set productName ='$product_name', productPrice = '$product_price', productImage = '$product_image'");
    if($insert_query>0){
   ...
   <body>
        <header>
            <nav class="nav-services">
                ...
                <ul class="nav-items">
                    ...
                    <li><a href="adminpage.php" class="curr-page">
                        Schedules
                    </a></li>
        ...
        <main>
            <div class="adminpage-table">
                <?php
                    $query = "SELECT schedule_id, name, contact_number, service_name, date, time, total_order, payment, date_ordered FROM schedule_table";
                ...
                <tr>
                    ...
                    <td><?php echo $data['date_ordered']; ?> </td>
                <tr>
                <?php
                $sn++;}} else { ?>
                    <tr>
